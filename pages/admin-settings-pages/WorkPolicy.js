...
export class WorkPolicy
{
    constructor(page)
    {
        ...
        this.deductionType=page.locator("[title='Fixed Amount']");
        this.amount1=page.getByPlaceholder("Enter Amount").first();
        this.amount2=page.getByPlaceholder("Enter Amount").nth(1);
        this.amount3=page.getByPlaceholder("Enter Amount").last();
        this.deductionFrOpt1=page.locator("div.ant-select-selector").first();
        ...
        this.deductionTyOpt2=page.locator("div.ant-select-selector").nth(1);
        this.deductionType2=page.locator("[title='Fixed Amount']").last();
        ...
        this.deductionTyOpt3=page.locator("div.ant-select-selector").nth(2);
        this.deductionType3=page.locator("[title='Fixed Amount']").last();
